...
void helicopter_output(void)
{
  ...
  if (rtmIsMajorTimeStep(helicopter_M)) {
    ...
    rtb_VectorConcatenate[0] = helicopter_B.Gain_i;

    /* Gain: '<S12>/Gain' incorporates:
     *  Constant: '<Root>/pitch_ref'
     */
    rtb_VectorConcatenate[1] = helicopter_P.Gain_Gain_c *
    ...
    /* ToFile: '<S4>/To File2' */
    {
      if (!(++helicopter_DW.ToFile2_IWORK.Decimation % 1) &&
        ...
        if (fp != (NULL)) {
          ...
          u[0] = helicopter_M->Timing.t[1];
          u[1] = rtb_VectorConcatenate[0];
          u[2] = rtb_VectorConcatenate[1];
...
void helicopter_initialize(void)
{
  ...
  /* Start for ToFile: '<S4>/To File' */
  {
    ...
    if (rt_WriteMat4FileHeader(fp,2,0,"t")) {
      rtmSetErrorStatus(helicopter_M,
...
void helicopter_terminate(void)
{
  ...
  /* Terminate for ToFile: '<S4>/To File' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (rt_WriteMat4FileHeader(fp, 2, helicopter_DW.ToFile_IWORK.Count, "t"))
      {
        rtmSetErrorStatus(helicopter_M,
                          "Error writing header for t to MAT-file travel.mat");
      }
...
RT_MODEL_helicopter_T *helicopter(void)
{
  ...
  /* External mode info */
  helicopter_M->Sizes.checksums[0] = (289265295U);
  helicopter_M->Sizes.checksums[1] = (529287758U);
  helicopter_M->Sizes.checksums[2] = (2812756042U);
  helicopter_M->Sizes.checksums[3] = (1437905176U);
