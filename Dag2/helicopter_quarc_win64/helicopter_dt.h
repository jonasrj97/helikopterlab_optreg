...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&helicopter_B.TravelCounttorad), 0, 0, 19 }
  ,
  ...
  { (char_T *)(&helicopter_DW.FromWorkspace_PWORK.TimePtr), 11, 0, 19 },

  { (char_T *)(&helicopter_DW.HILInitialize_ClockModes[0]), 6, 0, 46 },

  { (char_T *)(&helicopter_DW.HILInitialize_POSortedChans[0]), 7, 0, 8 },

  { (char_T *)(&helicopter_DW.FromWorkspace_IWORK.PrevIndex), 10, 0, 7 }
};
...
static DataTypeTransition rtPTransitions[] = {
  ...
  { (char_T *)(&helicopter_P.Constant_Value), 0, 0, 35 },
