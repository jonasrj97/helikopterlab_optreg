...
#ifndef RTW_HEADER_helicopter_day4_h_
#define RTW_HEADER_helicopter_day4_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helicopter_day4_COMMON_INCLUDES_
# define helicopter_day4_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* helicopter_day4_COMMON_INCLUDES_ */

#include "helicopter_day4_types.h"
...
#define helicopter_day4_rtModel        RT_MODEL_helicopter_day4_T
...
#define rtB                            helicopter_day4_B
#define BlockIO                        B_helicopter_day4_T
#define rtX                            helicopter_day4_X
#define ContinuousStates               X_helicopter_day4_T
#define rtXdot                         helicopter_day4_XDot
#define StateDerivatives               XDot_helicopter_day4_T
#define tXdis                          helicopter_day4_XDis
#define StateDisabled                  XDis_helicopter_day4_T
#define rtP                            helicopter_day4_P
#define Parameters                     P_helicopter_day4_T
#define rtDWork                        helicopter_day4_DW
#define D_Work                         DW_helicopter_day4_T

/* Parameters (auto storage) */
struct P_helicopter_day4_T_ {
...
struct tag_RTM_helicopter_day4_T {
  const char_T *path;
...
extern P_helicopter_day4_T helicopter_day4_P;

/* Block signals (auto storage) */
extern B_helicopter_day4_T helicopter_day4_B;

/* Continuous states (auto storage) */
extern X_helicopter_day4_T helicopter_day4_X;

/* Block states (auto storage) */
extern DW_helicopter_day4_T helicopter_day4_DW;

/* Model entry point functions */
extern void helicopter_day4_initialize(void);
extern void helicopter_day4_output(void);
extern void helicopter_day4_update(void);
extern void helicopter_day4_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopter_day4_rtModel *helicopter_day4(void);
...
extern RT_MODEL_helicopter_day4_T *const helicopter_day4_M;
 ...
 *
 * '<Root>' : 'helicopter_day4'
 * '<S1>'   : 'helicopter_day4/Conversion'
 * '<S2>'   : 'helicopter_day4/Degrees to Radians'
 * '<S3>'   : 'helicopter_day4/Elevation controller'
 * '<S4>'   : 'helicopter_day4/Helicopter_interface'
 * '<S5>'   : 'helicopter_day4/Pitch controller'
 * '<S6>'   : 'helicopter_day4/Helicopter_interface/Elevation rad to deg'
 * '<S7>'   : 'helicopter_day4/Helicopter_interface/Elevation rate rad to deg'
 * '<S8>'   : 'helicopter_day4/Helicopter_interface/Pitch rad to deg'
 * '<S9>'   : 'helicopter_day4/Helicopter_interface/Pitch rate rad to deg'
 * '<S10>'  : 'helicopter_day4/Helicopter_interface/Pitch rate rad to deg1'
 * '<S11>'  : 'helicopter_day4/Helicopter_interface/Pitch rate rad to deg2'
 * '<S12>'  : 'helicopter_day4/Helicopter_interface/Pitch rate rad to deg3'
 * '<S13>'  : 'helicopter_day4/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helicopter_day4/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter_day4_h_ */
